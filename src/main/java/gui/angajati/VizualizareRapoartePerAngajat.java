...
public class VizualizareRapoartePerAngajat extends JDialog {
    ...
    public static void main(String[] args) {
        try {
            VizualizareRapoartePerAngajat dialog = new VizualizareRapoartePerAngajat(1);
     ...
     * Create the dialog.
     */
    public VizualizareRapoartePerAngajat(int idAngajat) {
        ...
        List<RaportPerformanta> reports = GestionareRapoarte.infoRapoartePtAngajat(idAngajat); 
